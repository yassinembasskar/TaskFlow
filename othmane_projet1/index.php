        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="firstpage.php">Logout</a></li>
  ...
  <footer>
    <div class="footer-content">
      ...
      <div class="taskflow-description">
        <br>
        <h3>Task Flow:</h3>
        <p>TaskFlow est une application web conçue pour aider les utilisateurs à gérer</p> 
    <p>efficacement leurs tâches et listes de choses à faire.</p>
      </div>
    </div>
